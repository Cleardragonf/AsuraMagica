...
public class TemperatureContainer extends PlayerTemperatureCapability{
		public static void setTemp(PlayerEntity player, World world) {
			 ...
			 */
					...
					int combine = findfireryBlocks + (findWateryBlocks + coolingoffBlock);
					player.getCapability(PlayerTemperatureProvider.PlayerTemperature).ifPresent(a -> {
						if(((PlayerTemperatureCapability)a).getPlayerTemp() >= ((PlayerTemperatureCapability)a).minTemp() && ((PlayerTemperatureCapability)a).getPlayerTemp() <= ((PlayerTemperatureCapability)a).maxTemp() ) {
							((PlayerTemperatureCapability)a).setPlayerTemp(combine);
						}
					...
					/**
					 * Begin Biome Checks and Weather Checks
					 */
					...
					if(player.world.canBlockSeeSky(player.getPosition())) {
						...
						for(Map.Entry<Biome, Integer> entry : map.entrySet()) {
							if(location.equals(entry.getKey())) {
								player.getCapability(PlayerTemperatureProvider.PlayerTemperature).ifPresent(a -> {
									if(((PlayerTemperatureCapability)a).getPlayerTemp() >= ((PlayerTemperatureCapability)a).minTemp() && ((PlayerTemperatureCapability)a).getPlayerTemp() <= ((PlayerTemperatureCapability)a).maxTemp() ) {
										((PlayerTemperatureCapability)a).setPlayerTemp(entry.getValue());
						...
						if(player.world.isRaining()) {
							player.getCapability(PlayerTemperatureProvider.PlayerTemperature).ifPresent(a -> {
								if(((PlayerTemperatureCapability)a).getPlayerTemp() >= ((PlayerTemperatureCapability)a).minTemp() && ((PlayerTemperatureCapability)a).getPlayerTemp() <= ((PlayerTemperatureCapability)a).maxTemp() ) {
									((PlayerTemperatureCapability)a).setPlayerTemp(-1);
									//System.out.println(a.playerTemp());
								}
						...
						//TODO Calculate with Biomes being reduced by 1...AND Remove Weather Check
						...
						map.put(Biomes.DEFAULT, 0);
						map.put(Biomes.PLAINS, 0);
						map.put(Biomes.DESERT, 3);
						map.put(Biomes.MOUNTAINS, 0);
						map.put(Biomes.FOREST, 0);
						map.put(Biomes.TAIGA, 1);
						map.put(Biomes.SWAMP, 1);
						map.put(Biomes.RIVER, 0);
						map.put(Biomes.NETHER, 0);
						map.put(Biomes.THE_END, 0);
						map.put(Biomes.FROZEN_OCEAN, -3);
						map.put(Biomes.FROZEN_RIVER, -3);
						map.put(Biomes.SNOWY_TUNDRA, -3);
						map.put(Biomes.SNOWY_MOUNTAINS, -3);
						map.put(Biomes.MUSHROOM_FIELDS, 0);
						map.put(Biomes.MUSHROOM_FIELD_SHORE, 0);
						map.put(Biomes.BEACH, 0);
						map.put(Biomes.DESERT_HILLS, 3);
						map.put(Biomes.WOODED_HILLS, 0);
						map.put(Biomes.TAIGA_HILLS, 1);
						map.put(Biomes.MOUNTAIN_EDGE, 0);
						map.put(Biomes.JUNGLE, 3);
						map.put(Biomes.JUNGLE_HILLS, 3);
						map.put(Biomes.JUNGLE_EDGE, 3);
						map.put(Biomes.DEEP_OCEAN, -1);
						map.put(Biomes.STONE_SHORE, 1);
						map.put(Biomes.SNOWY_BEACH, -2);
						map.put(Biomes.BIRCH_FOREST, 1);
						map.put(Biomes.BIRCH_FOREST_HILLS, 1);
						map.put(Biomes.DARK_FOREST, 1);
						map.put(Biomes.SNOWY_TAIGA, -3);
						map.put(Biomes.SNOWY_TAIGA_HILLS, -3);
						map.put(Biomes.GIANT_TREE_TAIGA, 1);
						map.put(Biomes.GIANT_TREE_TAIGA_HILLS, 1);
						map.put(Biomes.WOODED_MOUNTAINS, 0);
						map.put(Biomes.SAVANNA, 2);
						map.put(Biomes.SAVANNA_PLATEAU, 2);
						map.put(Biomes.BADLANDS, 2);
						map.put(Biomes.WOODED_BADLANDS_PLATEAU, 2);
						map.put(Biomes.BADLANDS_PLATEAU, 2);
						map.put(Biomes.SMALL_END_ISLANDS, 0);
						map.put(Biomes.END_MIDLANDS, 0);
						map.put(Biomes.END_HIGHLANDS, 0);
						map.put(Biomes.END_BARRENS, 0);
						map.put(Biomes.WARM_OCEAN, 1);
						map.put(Biomes.LUKEWARM_OCEAN, 1);
						map.put(Biomes.COLD_OCEAN, -1);
						map.put(Biomes.DEEP_WARM_OCEAN, 1);
						map.put(Biomes.DEEP_LUKEWARM_OCEAN, 1);
						map.put(Biomes.DEEP_COLD_OCEAN, -1);
						map.put(Biomes.DEEP_FROZEN_OCEAN, -3);
						map.put(Biomes.THE_VOID, 0);
						map.put(Biomes.SUNFLOWER_PLAINS, 0);
						map.put(Biomes.DESERT_LAKES, 3);
						map.put(Biomes.GRAVELLY_MOUNTAINS, 1);
						map.put(Biomes.FLOWER_FOREST, 1);
						map.put(Biomes.TAIGA_MOUNTAINS, 0);
						map.put(Biomes.SWAMP_HILLS, 2);
						map.put(Biomes.ICE_SPIKES, -2);
						map.put(Biomes.MODIFIED_JUNGLE, 3);
						map.put(Biomes.MODIFIED_JUNGLE_EDGE, 3);
						map.put(Biomes.TALL_BIRCH_FOREST, 1);
						map.put(Biomes.TALL_BIRCH_HILLS, 1);
						map.put(Biomes.DARK_FOREST_HILLS, 1);
						map.put(Biomes.SNOWY_TAIGA_MOUNTAINS, -3);
						map.put(Biomes.GIANT_SPRUCE_TAIGA, 1);
						map.put(Biomes.GIANT_SPRUCE_TAIGA_HILLS, 1);
						map.put(Biomes.MODIFIED_GRAVELLY_MOUNTAINS, 2);
						map.put(Biomes.SHATTERED_SAVANNA, 2);
						map.put(Biomes.SHATTERED_SAVANNA_PLATEAU, 2);
						map.put(Biomes.ERODED_BADLANDS, 2);
						map.put(Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU, 2);
						map.put(Biomes.MODIFIED_BADLANDS_PLATEAU, 2);
						map.put(Biomes.BAMBOO_JUNGLE, 3);
						for(Map.Entry<Biome, Integer> entry : map.entrySet()) {
							if(location.equals(entry.getKey())) {
								player.getCapability(PlayerTemperatureProvider.PlayerTemperature).ifPresent(a -> {
									if(((PlayerTemperatureCapability)a).getPlayerTemp() >= ((PlayerTemperatureCapability)a).minTemp() && ((PlayerTemperatureCapability)a).getPlayerTemp() <= ((PlayerTemperatureCapability)a).maxTemp() ) {
